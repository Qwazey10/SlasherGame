...
void ASlasherCharacter::BeginPlay()
{
	...
	{
		GEngine->AddOnScreenDebugMessage(1, 20, FColor::Red, "CrouchTimeline is null");
	}
...
/*
 *
 *				Damage Interface Implementation Functions. 
 *
 */

void ASlasherCharacter::DeathOfOwner_Implementation()
{
...
void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticBleed_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticPoison_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticBurning_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticFrost_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticBleed_End_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticPoison_End_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticBurning_End_Implementation()
{
	
}

void ASlasherCharacter::DmgInterfaceApplyEffectCosmeticFrost_End_Implementation()
{
...
void ASlasherCharacter::OnBlock()
{
	bIsBlocking = true;
}

void ASlasherCharacter::OnBlockRelease()
{
	bIsBlocking = false;
}

void ASlasherCharacter::AnimNotify_BlockWindowStart()
{
	//bIsBlocking = true;
}
