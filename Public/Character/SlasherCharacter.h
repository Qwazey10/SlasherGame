...
UCLASS(config=Game)
class ASlasherCharacter : public ACharacter, public IBPI_PlayerToEnemy, public IBPI_PlayerToInteractable , public IBPI_DamageInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual void PlayerToEnemyInterface_Attack_Implementation(AActor* InstigatingActor, float BaseWeaponDamage,
	EDamageType PrimaryDamageType, float PrimaryStatusAmt, EDamageType SecondaryDamageType, float SecondaryStatusAmt) override;

	//Damage Component Implementations
	virtual void DeathOfOwner_Implementation() override;
	
	virtual void DmgInterfaceApplyEffectCosmeticBleed_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticPoison_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticBurning_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticFrost_Implementation() override;

	virtual void DmgInterfaceApplyEffectCosmeticBleed_End_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticPoison_End_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticBurning_End_Implementation() override;
	virtual void DmgInterfaceApplyEffectCosmeticFrost_End_Implementation() override;
