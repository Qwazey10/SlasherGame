...
void UMenuContextButton::NativeOnMouseEnter(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
	...
	else
	{
		GEngine->AddOnScreenDebugMessage(-1, 20, FColor::Red,
		                                 "MenuContextButton::NativeOnMouseEnter -- DATA ASSET IS NOT VALID");
	}
}
...
FReply UMenuContextButton::NativeOnMouseButtonDown(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
		...
		case EInventoryContext::UseItem:
			{
				...
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext = EInventoryContext::UseItem;
				//Set the AC MenuManager enum value to context
		...
		case EInventoryContext::UseMagic:
			{
				PlayerCharacter->PrimaryContextMenuManager->PrimaryMenuWidget->SetVisibility(ESlateVisibility::Hidden);
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext =
					EInventoryContext::UseMagic; //Set the AC MenuManager enum value to context
				PlayerCharacter->PrimaryContextMenuManager->UseMagicMenuWidget->
		...
		case EInventoryContext::Equipment:
			{
				...
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext =
					EInventoryContext::Equipment; //Set the AC MenuManager enum value to context
				PlayerCharacter->PrimaryContextMenuManager->EquipmentMenuWidget->SetVisibility(
		...
		case EInventoryContext::Stats:
			{
				PlayerCharacter->PrimaryContextMenuManager->PrimaryMenuWidget->SetVisibility(ESlateVisibility::Hidden);
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext = EInventoryContext::Stats;
				//Set the AC MenuManager enum value to context
				PlayerCharacter->PrimaryContextMenuManager->CompleteStatsWidget->SetVisibility(
					ESlateVisibility::Visible);
				break;
			}
		...
		case EInventoryContext::DropItem:
			{
				...
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext =
					EInventoryContext::DropItem; //Set the AC MenuManager enum value to context
				...
				GEngine->AddOnScreenDebugMessage(-1, 25, FColor::Red,
				                                 "MenuContextButton.cpp -- DROP ITEM NOT IMPLEMENTED, Potential Code Commented");
				break;
			}
		...
		case EInventoryContext::Options:
			{
				PlayerCharacter->PrimaryContextMenuManager->PrimaryMenuWidget->SetVisibility(ESlateVisibility::Hidden);
				// Set Primary Menu to Hidden
				PlayerCharacter->PrimaryContextMenuManager->ACContextMenu_InventoryContext = EInventoryContext::Options;
				//Set the AC MenuManager enum value to context
	...
	else
	{
		...
		{
			GEngine->AddOnScreenDebugMessage(-1, 20, FColor::Red,
			                                 "MENU CONTEXT BUTTON.cpp, Character REFERENCE is INVALID for ON PRESS");
		}
	}
...
void UMenuContextButton::NativeOnDragDetected(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent,
