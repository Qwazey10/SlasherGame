...
UCLASS()
class SLASHER_API AInteractableBase : public AActor ,public IBPI_PlayerToInteractable, public IBPI_PlayerToEnemy
{
	GENERATED_BODY()
...
public:	
	...
	//Status Buildup Vars
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Damage System Attributes")
	float InteractableBaseBurnBuildup = 0.0f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Damage System Attributes")
	float InteractableBasePoisonBuildup = 0.0f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Damage System Attributes")
	float InteractableBaseFrostBuildup = 0.0f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Damage System Attributes")
	float InteractableBaseBleedBuildup = 0.0f;
